...
import com.hojy.bracelet.presenter.ElectronicFencePresenter;
import com.hojy.bracelet.ui.view.CircleImageView;
...
public class ElectronicFenceActivity extends BaseActivity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, AMap.OnMapLoadedListener, AMap.OnCameraChangeListener, GeocodeSearch.OnGeocodeSearchListener {
    ...
    private ResponseInfoModel.DataBean mResultBean;
    ...
    protected void init() {
        ...
        mResultBean = (ResponseInfoModel.DataBean) getIntent().getSerializableExtra("location");
        ...
        LogUtils.d(TAG, "mFromMark: " + mFromMark);
        LogUtils.d(TAG, "mFenceId: " + mFenceId);
        LogUtils.d(TAG, "mName: " + mName);
        LogUtils.d(TAG, "mLng:  " + mLng);
        LogUtils.d(TAG, "mLat:  " + mLat);
        LogUtils.d(TAG, "mDesc:  " + mDesc);
    ...
    private void initData() {
        LogUtils.i(TAG, "FormMark=" + mFromMark);
        //添加
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        LogUtils.e(TAG,"onActivityResult  resultCode" +resultCode);
...
//                addMarkersToMap(mLatLng);
    ...
    private void initLocationView() {
        ...
        mCivIcon = mLocationInforPopupWindow
                .findViewById(R.id.civ_icon);
//        if (HomeActivity.sBitmap != null) {
...
//        } else {
//        }
            mCivIcon.setImageResource(R.mipmap.electronic_location);
    }
    ...
    public void onMapLoaded() {
        LogUtils.e(TAG, "onMapLoaded!!" + mLatLng.latitude);
        addMarkersToMap(mLatLng);
        if ("Edit".equals(mFromMark)) {
    ...
    public void onCameraChange(CameraPosition cameraPosition) {
        ...
        mProgressBar.setImageResource(R.drawable.juhua);
        ...
        if (rCode == 1000) {
            if (regeocodeResult != null) {
                if (regeocodeResult.getRegeocodeAddress() != null) {
                    ...
                    LogUtils.e(TAG,"regeocodeResult.getRegeocodeAddress() == null");
                }
            }else {
                LogUtils.e("regeocodeResult == null");
            }
        }
    }
