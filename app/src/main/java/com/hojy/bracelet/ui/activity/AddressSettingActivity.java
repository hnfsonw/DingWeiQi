...
import com.hojy.bracelet.presenter.AddressSettingPresenter;
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_right:
                ...
                mAddressSettingPresenter.save(addressName, mNumber, MyApplication.sAcountId, MyApplication.sDeviceId
                        , mLatLng.latitude, mLatLng.longitude, mRadius, MyApplication.sToken, mFenceId, mAddress);
                break;
        }
    }
