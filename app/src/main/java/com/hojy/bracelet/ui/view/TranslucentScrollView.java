...
/**
 * Created by LoyBin on 2018/4/13.
 */
...
public class TranslucentScrollView extends ScrollView {
    ...
    //渐变颜色
    private int transColor = Color.BLUE;
    //渐变开始位置
    ...
    public void setTransView(View transView) {
        setTransView(transView, getResources().getColor(R.color.colorPrimary), UIUtils.dip2px(getContext(), DFT_TRANSSTARTY), UIUtils.dip2px(getContext(), DFT_TRANSENDY));
    }
    ...
    private int getTransAlpha() {
        ...
        Log.d(TAG,"获取透明度 transStartY = " +transStartY);
        Log.d(TAG,"获取透明度 scrollY = " +scrollY);
        Log.d(TAG,"获取透明度 transEndY = " +transEndY);
        if (transStartY != 0) {
