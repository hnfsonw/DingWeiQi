...
public class AddressSettingDialog extends AlertDialog {
    ...
    @BindView(R.id.ll_administrator_unbundling)
    LinearLayout mLlAdministratorUnbundling;
    ...
    public void setText(String attributeOne, String attributeTow, String attributeThree,Boolean isShow) {
        mTvAttributeOne.setText(attributeOne);
        mTvAttributeTow.setText(attributeTow);
        mTvAttributeThree.setText(attributeThree);
        if (isShow){
            mLlEnterTheReminder.setVisibility(View.GONE);
            mLlAdministratorUnbundling.setVisibility(View.VISIBLE);
        }else {
            mLlEnterTheReminder.setVisibility(View.VISIBLE);
            mLlAdministratorUnbundling.setVisibility(View.GONE);
        }
    }
