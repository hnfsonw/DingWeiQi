...
import com.hojy.bracelet.presenter.DevicesHistoryPresenter;
import com.hojy.bracelet.ui.view.CalendarDialog;
...
public class DevicesHistoryActivity extends BaseActivity {
    ...
    public List<ResponseInfoModel.DataBean.LocationListBean> mHistoryList;
    public int index;
    ...
    protected void init() {
        ...
        LogUtils.d(TAG, "FORMATTER.format(mDate: " + FORMATTER.format(mDate));
        if (mSimpleDateFormat == null) {
            mSimpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        }
        String data = mSimpleDateFormat.format(mDate);
        LogUtils.d(TAG, "mDate: " + data);
...
//             设置移动的监听事件  返回 距终点的距离  单位 米
    ...
    private void showCalendar() {
        ...
        params.x = 0;//设置x坐标
        params.y = UIUtils.px2Dip(-712);//设置y坐标
...
//            mBtnPlay.setText(getString(R.string.play_track));
    ...
    public void onSuccess(ResponseInfoModel data) {
        List<ResponseInfoModel.DataBean.LocationListBean> historyLocations
                = data.getData().getLocationList();
     ...
     */
    private void collections(List<ResponseInfoModel.DataBean.LocationListBean> historyLocations) {
        Collections.sort(historyLocations,
                new Comparator<ResponseInfoModel.DataBean.LocationListBean>() {
                    @Override
                    public int compare(ResponseInfoModel.DataBean.LocationListBean o1,
                                       ResponseInfoModel.DataBean.LocationListBean o2) {
                        long time2 = 0;
                        long time = 0;
                        //降序排序
